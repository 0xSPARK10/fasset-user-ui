...
export default function EcoSystemInformationCard({ ecoSystemInfo }: IEcoSystemInformationCard) {
    ...
    return (
        ...
        >
            <Grid.Col span={{ base: 12, sm: 3 }} className="px-[15px] lg:px-3 py-2 border-x-0 md:border-x border border-[var(--flr-border-color)]">
                <div className="flex items-center md:block">
                    <Text
                        ...
                        c="var(--flr-dark-gray)"
                    >
                        {t('home.number_of_redeemed_lots_label')}
                    </Text>
                    <Divider
                    ...
                    <Text
                        ...
                        c="var(--flr-black)"
                    >
                        {formatNumberWithSuffix(ecoSystemInfo?.numRedeems ?? 0, 0)}
                    </Text>
                </div>
            </Grid.Col>
            <Grid.Col span={{ base: 12, sm: 3 }} className="px-[15px] lg:px-3 py-2 border-x-0 md:border-x border border-[var(--flr-border-color)]">
            ...
            <Grid.Col span={{ base: 12, sm: 3 }} className="px-[15px] lg:px-3 py-2 border-x-0 md:border-x md:border-y border-[var(--flr-border-color)]">
                <div className="flex items-center md:block">
                    <Text
                        className="text-12 uppercase basis-9/12"
                        fw={400}
