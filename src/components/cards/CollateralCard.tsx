...
export default function CollateralCard({ ecoSystemInfo, timeData }: ICollateralCard) {
    ...
    return (
        <div className="flex flex-col bg-[var(--flr-lightest-gray)] max-[768px]:border-t-0 border-x-0 md:border-x border border-[var(--flr-border-color)] h-full">
            ...
            >
                <div className="flex flex-col justify-center basis-1/2 border-b border-[var(--flr-border-color)] px-[15px] lg:px-6 py-3">
                    <Text
                ...
                <div className="flex flex-col justify-center basis-1/2 px-[15px] lg:px-6 py-3">
                    ...
                    <div className="flex flex-wrap sm:flex-nowrap mt-4 -ml-4">
                        {collateralTokens?.map((token, index) => (
                            <div key={index}>
                                <div className="px-4 py-2">
                                    ...
                                    <span className="text-14 text-[var(--flr-dark-gray)]">
